...
import com.chensoul.bookstore.order.domain.model.CreateOrderResponse;
import com.chensoul.bookstore.order.domain.model.OrderDTO;
import com.chensoul.bookstore.order.domain.model.OrderSummary;
...
class OrderResource {
    ...
    OrderResource(OrderService orderService, SecurityService securityService) {
